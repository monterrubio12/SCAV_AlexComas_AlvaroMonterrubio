...
async def test_resolution_adaptor(width: int, height: int):
    input_path = f"../Practice_2/input_file/bbb.mov"
    output_file = f"bbb_{width}x{height}.mp4"
    output_path = f"../Practice_2/output_file/{output_file}"
...
async def test_get_metadata():
    ...
    metadata_path = f"../Practice_2/output_file/{metadata_file}"
...
async def test_mp4_reader():
    input_path = f"../Practice_2/input_file/bbb.mp4"
